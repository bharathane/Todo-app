...
let sectionChill = document.getElementById("sectionChill")
sectionChill.classList.add("d-none")

function anotherpage() {
    sectionHome.classList.add("d-none")
    sectionChill.classList.remove("d-none")
}
...
jokeBtn.addEventListener("click", display)